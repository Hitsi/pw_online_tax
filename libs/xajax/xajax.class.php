 ...
 * File: xajax.clas.php
 *
 * xajax is an open source PHP 5 class library for easily creating powerful
 ...
 * @copyright Copyright (c) 2007 by Samolisov Pavel <samolisov@gmail.com>
 */
...
require_once ("xajaxResponse.class.php");
...
/**
 * The xajax class generates the bxajax javascript for your page including the 
...
class xajax {
     ...
     */
    function __construct($sEncoding = XAJAX_DEFAULT_CHAR_ENCODING, $bDebug = false, $sRequestURI = "", $sWrapperPrefix = "xajax_") {
     ...
     * array element . Note: the function name is what you
