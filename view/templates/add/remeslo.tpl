...
{% block html_title %}{{ parent() }} | Ремесло{% endblock %}
{% block main %}
<div class="center">Конкурс ремесленников</div>
<div id="result"></div>
<div class="col_2"></div>
    ...
    <div class="col_3 center">
        ...
        <table cellspacing="0" cellpadding="0" border="1px">
            ...
            <tbody>
                <tr>
                    <th>Был</th>
                    <td class="center"><input type="text" name="ball_in" id="ball_in" value="{% if Const.remeslo_in!="" %}{{ Const.remeslo_in }}{% else %}0{% endif %}" style="width:100px"></td>
                </tr>
                <tr>
                    <th>Не был</th>
                    <td class="center"><input type="text" name="ball_out" id="ball_out" value="{% if Const.remeslo_out!="" %}{{ Const.remeslo_out }}{% else %}0{% endif %}" style="width:100px"></td>
                </tr>
                <tr>
                    <th>НИС</th>
                    <td class="center"><input type="text" name="nis" id="nis" style="width:100px" value="{% if Const.nis!="" %}{{ Const.nis }}{% else %}0{% endif %}"></td>
                </tr>
                <tr>
                    <th>Фонд</th>
                    <td class="center"><input type="text" name="fond" id="fond" style="width:100px" value="{% if Const.fond!="" %}{{ Const.fond }}{% else %}0{% endif %}"></td>
                </tr>
                <tr>
                    <th>Обновить</th>
